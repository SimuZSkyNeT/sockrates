...
```bash
wget https://github.com/SimuZSkyNeT/sockrates/releases/latest/download/sockrates_0.2.2_all.deb
sudo apt install ./sockrates_0.2.2_all.deb
```
...
```bash
sudo dnf install https://github.com/SimuZSkyNeT/sockrates/releases/latest/download/sockrates-0.2.2-1.noarch.rpm
```
