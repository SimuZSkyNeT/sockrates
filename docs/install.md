...
```bash
wget https://github.com/SimuZSkyNeT/sockrates/releases/latest/download/sockrates_0.5.0_all.deb
sudo apt install ./sockrates_0.5.0_all.deb
```
...
```bash
sudo dnf install https://github.com/SimuZSkyNeT/sockrates/releases/latest/download/sockrates-0.5.0-1.noarch.rpm
```
